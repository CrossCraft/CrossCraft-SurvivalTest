...
namespace CrossCraft
{
    ...
    {
        YAML::Node config =
            YAML::LoadFile(PLATFORM_APP_FILE_PREFIX + "models/spider.yaml");
        ...
        tex = TexturePackManager::get().load_texture(
            "assets/mob/spider.png", SC_TEX_FILTER_NEAREST, SC_TEX_FILTER_NEAREST,
            false, false);
    }
    ...
    void Spider::draw(SpiderData *sd)
    {
        ...
        leg.draw({ 0.0625f + 0.3125f, -0.1875f, -0.1875f }, { 0, 135, 70 }, { 1, 1, 1 });
        leg.draw({ 0.0625f + 0.34375f, -0.1875f, -0.1875f }, { 0, 105, 70 }, { 1, 1, 1 });
        leg.draw({ 0.0625f + 0.375f, -0.1875f, -0.1875f }, { 0, 75, 70 }, { 1, 1, 1 });
        leg.draw({ 0.0625f + 0.40625f, -0.1875f, -0.1875f }, { 0, 45, 70 }, { 1, 1, 1 });
