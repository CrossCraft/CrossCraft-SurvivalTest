...
#define SCREEN_CENTER (SCREEN_W / 2)
    ...
    auto UserInterface::draw_text(std::string text, unsigned char color, unsigned char x_align, unsigned char y_align, short x_line, short y_line, short bg_mode, int pXoff, int pYoff) -> void {
        ...
        switch (x_align) {
            ...
            case CC_TEXT_ALIGN_CENTER:
                x_position = SCREEN_CENTER - 1 -
                             static_cast<short>(textHelper->get_width(text) / 2);
                break;
